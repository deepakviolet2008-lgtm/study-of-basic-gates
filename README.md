...
module DS_exp1 ( input a, input b, output and_out, output or_out, output not_out, output xor_out, output xnor_out, output nand_out, output nor_out );
```
